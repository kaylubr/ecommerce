            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class='bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300'>
                    ...
                    <div class='flex space-x-2'>
                        <a href='edit_product.php?id=" . htmlspecialchars($row['id']) . "' class='inline-block bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-500 transition-all'>
                            <i class='fas fa-edit'></i> Edit Product
                        </a>
                        <a href='delete_product.php?id=" . htmlspecialchars($row['id']) . "' class='inline-block bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-500 transition-all'>
